...
# honeypot configs
HONEYPOT_LOGIN_TRYOUT = config("HONEYPOT_LOGIN_TRYOUT", cast=int, default=3)
HONEYPOT_RATE_LIMIT = config("HONEYPOT_RATE_LIMIT", cast=int, default=10)
HONEYPOT_RATE_WINDOW_SECONDS = config("HONEYPOT_RATE_WINDOW_SECONDS", cast=int, default=60)
HONEYPOT_ALERT_EMAIL = config("HONEYPOT_ALERT_EMAIL", default=None)
HONEYPOT_ALERT_WEBHOOK = config("HONEYPOT_ALERT_WEBHOOK", default=None)
HONEYPOT_ALERT_THRESHOLD = config("HONEYPOT_ALERT_THRESHOLD", default=None, cast=lambda v: int(v) if v else None)